...
async function generate() {
  ...
  const eventKeywords = ["basant", "festivals", "lohri", "baisakhi", "carnival", "picnic", "fancydress", "diwali"];
  const informationalKeywords = ["celebrations", "controls", "infographic", "facilities", "dentalcheckup", "bestfacilities", "summercamp", "friendship-day"];
